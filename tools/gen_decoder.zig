// generates decode.js from the AST type definitions.
// uses the same comptime layout functions as the serializer in raw_transfer.zig,
// guaranteeing the decoder always matches the binary format.

const std = @import("std");
const parser = @import("parser");
const ast = parser.ast;
const rt = parser.raw_transfer;
...
fn generate(w: *Writer) !void {
    try w.writeAll(
        \\// generated by tools/gen_decoder.zig -- do not edit
        \\"use strict";
    ...
    try w.writeAll("module.exports = { decode };\n");
}
