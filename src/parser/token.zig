...
pub const TokenTag = enum(u32) {
    ...
    as = 106 | Mask.IsKeyword | Mask.IsIdentifierLike, // "as"
    ...
    typeof = 117 | (14 << Mask.PrecShift) | Mask.IsUnaryOp | Mask.IsKeyword | Mask.IsUnconditionallyReserved | Mask.IsIdentifierLike, // "typeof"
    ...
    delete = 121 | (14 << Mask.PrecShift) | Mask.IsUnaryOp | Mask.IsKeyword | Mask.IsUnconditionallyReserved | Mask.IsIdentifierLike, // "delete"
    void = 122 | (14 << Mask.PrecShift) | Mask.IsUnaryOp | Mask.IsKeyword | Mask.IsUnconditionallyReserved | Mask.IsIdentifierLike, // "void"
    ...
    satisfies = 141 | Mask.IsKeyword | Mask.IsIdentifierLike, // "satisfies"
