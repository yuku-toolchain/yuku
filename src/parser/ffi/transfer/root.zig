// AST transfer format v9, the wire format in both FFI directions. little endian, no
...
//   IndexRange        2 u32 slots (start, len)
...
pub const NODE_HEADER_U32S: u8 = @offsetOf(PackedNode, "slots") / 4;
