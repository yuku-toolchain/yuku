...
![Native benchmark chart comparing Yuku, Oxc, and other Zig/Rust parsers parsing typescript.js](https://raw.githubusercontent.com/yuku-toolchain/parser-benchmark-native/refs/heads/main/charts/typescript.png)

<span style="font-size: 0.8rem; color: var(--sl-color-gray-3);">Parsing speed for the `typescript.js` file (7.8 MB) · macOS (ARM) | Apple M4 Pro · [Source](https://github.com/yuku-toolchain/parser-benchmark-native)</span>
...
![JavaScript benchmark chart comparing Yuku, Oxc, Acorn, and other npm parsers parsing react.js](https://raw.githubusercontent.com/yuku-toolchain/parser-benchmark-js/refs/heads/main/charts/react.png)

<span style="font-size: 0.8rem; color: var(--sl-color-gray-3);">Parsing speed for the `react.js` file (72 KB) via npm packages · macOS (ARM) | Apple M4 Pro · [Source](https://github.com/yuku-toolchain/parser-benchmark-js)</span>

<BenchmarkTable variant="js" source="react" />

![JavaScript benchmark chart comparing Yuku, Oxc, Acorn, and other npm parsers parsing typescript.js](https://raw.githubusercontent.com/yuku-toolchain/parser-benchmark-js/refs/heads/main/charts/typescript.png)

<span style="font-size: 0.8rem; color: var(--sl-color-gray-3);">Parsing speed for the `typescript.js` file (7.8 MB) via npm packages · macOS (ARM) | Apple M4 Pro · [Source](https://github.com/yuku-toolchain/parser-benchmark-js)</span>
