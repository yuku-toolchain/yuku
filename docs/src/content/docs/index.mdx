...
More tooling is planned (a minifier, resolver, transpiler including `.d.ts` generation, and more), built incrementally, one component at a time. Contributions are welcome and will help accelerate development.
