...
On the JavaScript side, Yuku is **2-5x faster** than alternatives:
...
![JavaScript Benchmark: Parsing TypeScript source to JavaScript](https://raw.githubusercontent.com/yuku-toolchain/parser-benchmark-js/refs/heads/main/charts/typescript.png)

<span style="font-size: 0.8rem; color: var(--sl-color-gray-3);">Parsing the bundled TypeScript compiler source (7.8 MB) · macOS (ARM) | Apple M4 Pro · [Source](https://github.com/yuku-toolchain/parser-benchmark-js)</span>
