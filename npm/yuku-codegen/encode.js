...
function encode(estree, comments, lineStarts) {
  ...
  function alloc() {
    if (nodeCount >= nodeCap) {
      ...
      nodeAB = nb;
      nU8 = new Uint8Array(nb);
      nU32 = new Uint32Array(nb);
    }
    const idx = nodeCount++;
  ...
  function tagAt(idx, tag) {
    nU8[idx * NODE_SIZE] = tag;
  }
  ...
  function asStart(n) {
    return n && typeof n.start === "number" ? n.start : 0;
  }
  function asEnd(n) {
    return n && typeof n.end === "number" ? n.end : 0;
  }
  ...
  function enc_function(n, kind) {
    ...
    flagsAt(
      idx,
      ((kind & 3) << 0) | (n.generator ? 4 : 0) | (n.async ? 8 : 0) | (n.declare ? 16 : 0),
    );
    spanAt(idx, asStart(n), asEnd(n));
    return idx;
  }
  ...
  function enc_member_expression(n) {
    ...
    const p =
      n.property == null ? NULL : n.computed ? encNode(n.property) : encPropertyKey(n.property);
    const idx = alloc();
    tagAt(idx, 18);
    slotAt(idx, 0, o);
    slotAt(idx, 1, p);
  ...
  function enc_regexp_literal(n) {
    ...
    const idx = alloc();
    tagAt(idx, 39);
    slotAt(idx, 0, p.start);
    slotAt(idx, 1, p.end);
    slotAt(idx, 2, fl.start);
    slotAt(idx, 3, fl.end);
    spanAt(idx, asStart(n), asEnd(n));
    return idx;
  }
  ...
  function enc_array_pattern(n) {
    ...
    slotAt(idx, 0, r.start);
    slotAt(idx, 1, rest);
    slotAt(idx, 2, decs.start);
    slotAt(idx, 3, decs.len);
    slotAt(idx, 4, ta);
  ...
  function enc_import_declaration(n) {
    ...
    flagsAt(
      idx,
      0 |
        (n.phase != null ? 1 | ((IMPORT_PHASE_INV[n.phase] | 0) << 1) : 0) |
        ((IMPORT_EXPORT_KINDS_INV[n.importKind] | 0) << 2),
    );
    spanAt(idx, asStart(n), asEnd(n));
    return idx;
  }
  ...
  function enc_ts_mapped_type(n) {
    ...
    flagsAt(
      idx,
      (TS_MAPPED_OPTIONAL_INV(n.optional) << 0) | (TS_MAPPED_READONLY_INV(n.readonly) << 2),
    );
    spanAt(idx, asStart(n), asEnd(n));
    return idx;
  }
  ...
  function enc_ts_parameter_property(n) {
    ...
    flagsAt(
      idx,
      0 | (n.override ? 1 : 0) | (n.readonly ? 2 : 0) | (ACCESSIBILITY_INV(n.accessibility) << 2),
    );
    spanAt(idx, asStart(n), asEnd(n));
    return idx;
  }
  ...
  function encNode(n) {
    ...
    switch (n.type) {
      case "Identifier":
        return enc_identifier_reference(n);
      case "PrivateIdentifier":
        return enc_private_identifier(n);
      case "Literal": {
      ...
      case "FunctionDeclaration":
        return enc_function(n, 0);
      case "FunctionExpression":
        return enc_function(n, 1);
      case "TSDeclareFunction":
        return enc_function(n, 2);
      case "TSEmptyBodyFunctionExpression":
        return enc_function(n, 3);
      case "ClassDeclaration":
        return enc_class(n, 0);
      case "ClassExpression":
        return enc_class(n, 1);
      case "MethodDefinition":
        return enc_method_definition(n, false);
      case "TSAbstractMethodDefinition":
        return enc_method_definition(n, true);
      case "PropertyDefinition":
        return enc_property_definition(n, false, false);
      case "TSAbstractPropertyDefinition":
        return enc_property_definition(n, false, true);
      case "AccessorProperty":
        return enc_property_definition(n, true, false);
      case "TSAbstractAccessorProperty":
        return enc_property_definition(n, true, true);
      case "RestElement":
        return enc_binding_rest_element(n);
      case "TSModuleDeclaration":
        return n.global ? enc_ts_global_declaration(n) : enc_ts_module_declaration(n);
      case "ExpressionStatement":
        return n.directive != null ? enc_directive(n) : enc_expression_statement(n);
      case "SequenceExpression":
        return enc_sequence_expression(n);
      case "ParenthesizedExpression":
        return enc_parenthesized_expression(n);
      case "ArrowFunctionExpression":
        return enc_arrow_function_expression(n);
      case "BlockStatement":
        return enc_block_statement(n);
      case "BinaryExpression":
        return enc_binary_expression(n);
      case "LogicalExpression":
        return enc_logical_expression(n);
      case "ConditionalExpression":
        return enc_conditional_expression(n);
      case "UnaryExpression":
        return enc_unary_expression(n);
      case "UpdateExpression":
        return enc_update_expression(n);
      case "AssignmentExpression":
        return enc_assignment_expression(n);
      case "ArrayExpression":
        return enc_array_expression(n);
      case "ObjectExpression":
        return enc_object_expression(n);
      case "SpreadElement":
        return enc_spread_element(n);
      case "Property":
        return enc_object_property(n);
      case "MemberExpression":
        return enc_member_expression(n);
      case "CallExpression":
        return enc_call_expression(n);
      case "ChainExpression":
        return enc_chain_expression(n);
      case "TaggedTemplateExpression":
        return enc_tagged_template_expression(n);
      case "NewExpression":
        return enc_new_expression(n);
      case "AwaitExpression":
        return enc_await_expression(n);
      case "YieldExpression":
        return enc_yield_expression(n);
      case "MetaProperty":
        return enc_meta_property(n);
      case "Decorator":
        return enc_decorator(n);
      case "ClassBody":
        return enc_class_body(n);
      case "StaticBlock":
        return enc_static_block(n);
      case "Super":
        return enc_super(n);
      case "ThisExpression":
        return enc_this_expression(n);
      case "TemplateLiteral":
        return enc_template_literal(n);
      case "TemplateElement":
        return enc_template_element(n);
      case "IfStatement":
        return enc_if_statement(n);
      case "SwitchStatement":
        return enc_switch_statement(n);
      case "SwitchCase":
        return enc_switch_case(n);
      case "ForStatement":
        return enc_for_statement(n);
      case "ForInStatement":
        return enc_for_in_statement(n);
      case "ForOfStatement":
        return enc_for_of_statement(n);
      case "WhileStatement":
        return enc_while_statement(n);
      case "DoWhileStatement":
        return enc_do_while_statement(n);
      case "BreakStatement":
        return enc_break_statement(n);
      case "ContinueStatement":
        return enc_continue_statement(n);
      case "LabeledStatement":
        return enc_labeled_statement(n);
      case "WithStatement":
        return enc_with_statement(n);
      case "ReturnStatement":
        return enc_return_statement(n);
      case "ThrowStatement":
        return enc_throw_statement(n);
      case "TryStatement":
        return enc_try_statement(n);
      case "CatchClause":
        return enc_catch_clause(n);
      case "DebuggerStatement":
        return enc_debugger_statement(n);
      case "EmptyStatement":
        return enc_empty_statement(n);
      case "VariableDeclaration":
        return enc_variable_declaration(n);
      case "VariableDeclarator":
        return enc_variable_declarator(n);
      case "AssignmentPattern":
        return enc_assignment_pattern(n);
      case "ArrayPattern":
        return enc_array_pattern(n);
      case "ObjectPattern":
        return enc_object_pattern(n);
      case "Program":
        return enc_program(n);
      case "ImportExpression":
        return enc_import_expression(n);
      case "ImportDeclaration":
        return enc_import_declaration(n);
      case "ImportSpecifier":
        return enc_import_specifier(n);
      case "ImportDefaultSpecifier":
        return enc_import_default_specifier(n);
      case "ImportNamespaceSpecifier":
        return enc_import_namespace_specifier(n);
      case "ImportAttribute":
        return enc_import_attribute(n);
      case "ExportNamedDeclaration":
        return enc_export_named_declaration(n);
      case "ExportDefaultDeclaration":
        return enc_export_default_declaration(n);
      case "ExportAllDeclaration":
        return enc_export_all_declaration(n);
      case "ExportSpecifier":
        return enc_export_specifier(n);
      case "TSTypeAnnotation":
        return enc_ts_type_annotation(n);
      case "TSAnyKeyword":
        return enc_ts_any_keyword(n);
      case "TSUnknownKeyword":
        return enc_ts_unknown_keyword(n);
      case "TSNeverKeyword":
        return enc_ts_never_keyword(n);
      case "TSVoidKeyword":
        return enc_ts_void_keyword(n);
      case "TSNullKeyword":
        return enc_ts_null_keyword(n);
      case "TSUndefinedKeyword":
        return enc_ts_undefined_keyword(n);
      case "TSStringKeyword":
        return enc_ts_string_keyword(n);
      case "TSNumberKeyword":
        return enc_ts_number_keyword(n);
      case "TSBigIntKeyword":
        return enc_ts_bigint_keyword(n);
      case "TSBooleanKeyword":
        return enc_ts_boolean_keyword(n);
      case "TSSymbolKeyword":
        return enc_ts_symbol_keyword(n);
      case "TSObjectKeyword":
        return enc_ts_object_keyword(n);
      case "TSIntrinsicKeyword":
        return enc_ts_intrinsic_keyword(n);
      case "TSThisType":
        return enc_ts_this_type(n);
      case "TSTypeReference":
        return enc_ts_type_reference(n);
      case "TSQualifiedName":
        return enc_ts_qualified_name(n);
      case "TSTypeQuery":
        return enc_ts_type_query(n);
      case "TSImportType":
        return enc_ts_import_type(n);
      case "TSTypeParameter":
        return enc_ts_type_parameter(n);
      case "TSTypeParameterDeclaration":
        return enc_ts_type_parameter_declaration(n);
      case "TSTypeParameterInstantiation":
        return enc_ts_type_parameter_instantiation(n);
      case "TSLiteralType":
        return enc_ts_literal_type(n);
      case "TSTemplateLiteralType":
        return enc_ts_template_literal_type(n);
      case "TSArrayType":
        return enc_ts_array_type(n);
      case "TSIndexedAccessType":
        return enc_ts_indexed_access_type(n);
      case "TSTupleType":
        return enc_ts_tuple_type(n);
      case "TSNamedTupleMember":
        return enc_ts_named_tuple_member(n);
      case "TSOptionalType":
        return enc_ts_optional_type(n);
      case "TSRestType":
        return enc_ts_rest_type(n);
      case "TSJSDocNullableType":
        return enc_ts_jsdoc_nullable_type(n);
      case "TSJSDocNonNullableType":
        return enc_ts_jsdoc_non_nullable_type(n);
      case "TSJSDocUnknownType":
        return enc_ts_jsdoc_unknown_type(n);
      case "TSUnionType":
        return enc_ts_union_type(n);
      case "TSIntersectionType":
        return enc_ts_intersection_type(n);
      case "TSConditionalType":
        return enc_ts_conditional_type(n);
      case "TSInferType":
        return enc_ts_infer_type(n);
      case "TSTypeOperator":
        return enc_ts_type_operator(n);
      case "TSParenthesizedType":
        return enc_ts_parenthesized_type(n);
      case "TSFunctionType":
        return enc_ts_function_type(n);
      case "TSConstructorType":
        return enc_ts_constructor_type(n);
      case "TSTypePredicate":
        return enc_ts_type_predicate(n);
      case "TSTypeLiteral":
        return enc_ts_type_literal(n);
      case "TSMappedType":
        return enc_ts_mapped_type(n);
      case "TSPropertySignature":
        return enc_ts_property_signature(n);
      case "TSMethodSignature":
        return enc_ts_method_signature(n);
      case "TSCallSignatureDeclaration":
        return enc_ts_call_signature_declaration(n);
      case "TSConstructSignatureDeclaration":
        return enc_ts_construct_signature_declaration(n);
      case "TSIndexSignature":
        return enc_ts_index_signature(n);
      case "TSTypeAliasDeclaration":
        return enc_ts_type_alias_declaration(n);
      case "TSInterfaceDeclaration":
        return enc_ts_interface_declaration(n);
      case "TSInterfaceBody":
        return enc_ts_interface_body(n);
      case "TSInterfaceHeritage":
        return enc_ts_interface_heritage(n);
      case "TSClassImplements":
        return enc_ts_class_implements(n);
      case "TSEnumDeclaration":
        return enc_ts_enum_declaration(n);
      case "TSEnumBody":
        return enc_ts_enum_body(n);
      case "TSEnumMember":
        return enc_ts_enum_member(n);
      case "TSModuleBlock":
        return enc_ts_module_block(n);
      case "TSParameterProperty":
        return enc_ts_parameter_property(n);
      case "TSAsExpression":
        return enc_ts_as_expression(n);
      case "TSSatisfiesExpression":
        return enc_ts_satisfies_expression(n);
      case "TSTypeAssertion":
        return enc_ts_type_assertion(n);
      case "TSNonNullExpression":
        return enc_ts_non_null_expression(n);
      case "TSInstantiationExpression":
        return enc_ts_instantiation_expression(n);
      case "TSExportAssignment":
        return enc_ts_export_assignment(n);
      case "TSNamespaceExportDeclaration":
        return enc_ts_namespace_export_declaration(n);
      case "TSImportEqualsDeclaration":
        return enc_ts_import_equals_declaration(n);
      case "TSExternalModuleReference":
        return enc_ts_external_module_reference(n);
      case "JSXElement":
        return enc_jsx_element(n);
      case "JSXOpeningElement":
        return enc_jsx_opening_element(n);
      case "JSXClosingElement":
        return enc_jsx_closing_element(n);
      case "JSXFragment":
        return enc_jsx_fragment(n);
      case "JSXOpeningFragment":
        return enc_jsx_opening_fragment(n);
      case "JSXClosingFragment":
        return enc_jsx_closing_fragment(n);
      case "JSXIdentifier":
        return enc_jsx_identifier(n);
      case "JSXNamespacedName":
        return enc_jsx_namespaced_name(n);
      case "JSXMemberExpression":
        return enc_jsx_member_expression(n);
      case "JSXAttribute":
        return enc_jsx_attribute(n);
      case "JSXSpreadAttribute":
        return enc_jsx_spread_attribute(n);
      case "JSXExpressionContainer":
        return enc_jsx_expression_container(n);
      case "JSXEmptyExpression":
        return enc_jsx_empty_expression(n);
      case "JSXText":
        return enc_jsx_text(n);
      case "JSXSpreadChild":
        return enc_jsx_spread_child(n);
      default:
        throw new Error("yuku-codegen: unsupported ESTree node type: " + n.type);
    }
  }
