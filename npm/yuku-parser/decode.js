...
function decode(buffer, source) {
    ...
    switch (tag) {
      ...
      case 1:
        return {
          ...
          expression: f1 !== NULL ? node(f1) : null,
        };
      case 2: {
        const r = {
      ...
      case 10:
        return {
          ...
          test: f1 !== NULL ? node(f1) : null,
          consequent: f2 !== NULL ? node(f2) : null,
          alternate: f3 !== NULL ? node(f3) : null,
        };
      case 11:
        return {
      ...
      case 13:
        return {
          ...
          left: f1 !== NULL ? node(f1) : null,
          right: f2 !== NULL ? node(f2) : null,
          operator: ASSIGNMENT_OPS[flags & 15],
        };
      case 14:
      ...
      case 16:
        return { type: "SpreadElement", start, end, argument: f1 !== NULL ? node(f1) : null };
      case 17: {
        const r = {
          type: "Property",
          start,
          end,
          key: f1 !== NULL ? node(f1) : null,
          value: f2 !== NULL ? node(f2) : null,
          kind: PROPERTY_KINDS[flags & 3],
          method: !!(flags & 4),
          shorthand: !!(flags & 8),
          computed: !!(flags & 16),
        };
      ...
      case 18:
        return {
          ...
          object: f1 !== NULL ? node(f1) : null,
          property: f2 !== NULL ? node(f2) : null,
          computed: !!(flags & 1),
          optional: !!(flags & 2),
        };
      case 19: {
        const r = {
          ...
          callee: f1 !== NULL ? node(f1) : null,
          arguments: nodeArr(f2, f0),
          optional: !!(flags & 1),
        };
        if (_isTs) {
          r.typeArguments = f3 !== NULL ? node(f3) : null;
        }
        return r;
      }
      case 20:
        return { type: "ChainExpression", start, end, expression: f1 !== NULL ? node(f1) : null };
      case 21: {
        const r = {
          type: "TaggedTemplateExpression",
          start,
          end,
          tag: f1 !== NULL ? node(f1) : null,
          quasi: f2 !== NULL ? node(f2) : null,
        };
        if (_isTs) {
          r.typeArguments = f3 !== NULL ? node(f3) : null;
        }
      ...
      case 23:
        return { type: "AwaitExpression", start, end, argument: f1 !== NULL ? node(f1) : null };
      case 24:
        return {
      ...
      case 25:
        return {
          ...
          meta: f1 !== NULL ? node(f1) : null,
          property: f2 !== NULL ? node(f2) : null,
        };
      case 26:
        return { type: "Decorator", start, end, expression: f1 !== NULL ? node(f1) : null };
      case 27: {
        const r = {
          type: CLASS_TYPES[flags & 1],
          start,
          end,
      ...
      case 30: {
        ...
        if (_isTs) {
          ...
          if (_abs) r.type = _acc ? "TSAbstractAccessorProperty" : "TSAbstractPropertyDefinition";
        }
        return r;
      }
      case 31:
      ...
      case 33:
        return { type: "Literal", start, end, value: str(f1, f2), raw: _src.slice(start, end) };
      case 34: {
        const r = _src.slice(start, end);
        const s = r.indexOf("_") === -1 ? r : r.replace(/_/g, "");
        const v = (flags & 3) === 2 && s[1] !== "o" && s[1] !== "O" ? parseInt(s.slice(1), 8) : +s;
        return { type: "Literal", start, end, value: v === v && isFinite(v) ? v : null, raw: r };
      }
      case 35: {
        const r = _src.slice(start, end);
        const d = str(f1, f2).replace(/_/g, "");
        const v = BigInt(d);
        return { type: "Literal", start, end, value: v, raw: r, bigint: v.toString() };
      }
      case 36: {
        const v = !!(flags & 1);
        return { type: "Literal", start, end, value: v, raw: v ? "true" : "false" };
      }
      case 37:
      ...
      case 40:
        return {
          ...
          quasis: nodeArr(f1, f0),
          expressions: nodeArr(f2, f3),
        };
      case 41: {
        ...
        return {
          ...
          value: { raw, cooked: flags & 2 ? null : str(f1, f2) },
          tail: tl,
        };
      }
      case 42: {
        const r = { type: "Identifier", start, end, name: str(f1, f2) };
        if (_isTs) {
          r.decorators = [];
          r.optional = false;
      ...
      case 49:
        return {
          ...
          discriminant: f1 !== NULL ? node(f1) : null,
          cases: nodeArr(f2, f0),
        };
      case 50:
        return {
      ...
      case 51:
        return {
          ...
          init: f1 !== NULL ? node(f1) : null,
          test: f2 !== NULL ? node(f2) : null,
          update: f3 !== NULL ? node(f3) : null,
          body: f4 !== NULL ? node(f4) : null,
        };
      case 52:
        return {
          type: "ForInStatement",
      ...
      case 61:
        return { type: "ThrowStatement", start, end, argument: f1 !== NULL ? node(f1) : null };
      case 62:
        return {
          type: "TryStatement",
          start,
          end,
          block: f1 !== NULL ? node(f1) : null,
          handler: f2 !== NULL ? node(f2) : null,
          finalizer: f3 !== NULL ? node(f3) : null,
        };
      case 63:
        return {
          type: "CatchClause",
      ...
      case 66: {
        const r = {
          ...
          kind: VAR_KINDS[flags & 7],
          declarations: nodeArr(f1, f0),
        };
        if (_isTs) {
          r.declare = !!(flags & 8);
        }
      ...
      case 70: {
        const r = { type: "RestElement", start, end, argument: f1 !== NULL ? node(f1) : null };
        if (_isTs) {
          r.decorators = nodeArr(f2, f0);
      ...
      case 74:
        return {
          ...
          hashbang:
            flags & 2
              ? { type: "Hashbang", start: _p(f2 - 2), end: _p(f3), value: str(f2, f3) }
              : null,
          body: nodeArr(f1, f0),
        };
      case 75:
        return {
          ...
          source: f1 !== NULL ? node(f1) : null,
          options: f2 !== NULL ? node(f2) : null,
          phase: flags & 1 ? ["source", "defer"][(flags >> 1) & 1] : null,
        };
      case 76: {
        const r = {
          ...
          specifiers: nodeArr(f1, f0),
          source: f2 !== NULL ? node(f2) : null,
          attributes: nodeArr(f3, f4),
          phase: flags & 1 ? ["source", "defer"][(flags >> 1) & 1] : null,
        };
        if (_isTs) {
          r.importKind = IMPORT_EXPORT_KINDS[(flags >> 2) & 1];
        }
        return r;
      }
      case 77: {
        const r = {
          ...
          imported: f1 !== NULL ? node(f1) : null,
          local: f2 !== NULL ? node(f2) : null,
        };
        if (_isTs) {
          r.importKind = IMPORT_EXPORT_KINDS[flags & 1];
        }
        return r;
      }
      case 78:
        return { type: "ImportDefaultSpecifier", start, end, local: f1 !== NULL ? node(f1) : null };
      case 79:
        return {
          type: "ImportNamespaceSpecifier",
          start,
          end,
          local: f1 !== NULL ? node(f1) : null,
        };
      case 80:
        return {
      ...
      case 81: {
        const r = {
          ...
          declaration: f1 !== NULL ? node(f1) : null,
          specifiers: nodeArr(f2, f0),
          source: f3 !== NULL ? node(f3) : null,
          attributes: nodeArr(f4, f5),
        };
        if (_isTs) {
          r.exportKind = IMPORT_EXPORT_KINDS[flags & 1];
        }
        return r;
      }
      case 82: {
      ...
      case 83: {
        const r = {
          ...
          exported: f1 !== NULL ? node(f1) : null,
          source: f2 !== NULL ? node(f2) : null,
          attributes: nodeArr(f3, f0),
        };
        if (_isTs) {
          r.exportKind = IMPORT_EXPORT_KINDS[flags & 1];
        }
      ...
      case 86:
        return { type: "TSAnyKeyword", start, end };
      case 87:
        return { type: "TSUnknownKeyword", start, end };
      case 88:
        return { type: "TSNeverKeyword", start, end };
      case 89:
        return { type: "TSVoidKeyword", start, end };
      case 90:
        return { type: "TSNullKeyword", start, end };
      case 91:
        return { type: "TSUndefinedKeyword", start, end };
      case 92:
        return { type: "TSStringKeyword", start, end };
      case 93:
        return { type: "TSNumberKeyword", start, end };
      case 94:
        return { type: "TSBigIntKeyword", start, end };
      case 95:
        return { type: "TSBooleanKeyword", start, end };
      case 96:
        return { type: "TSSymbolKeyword", start, end };
      case 97:
        return { type: "TSObjectKeyword", start, end };
      case 98:
        return { type: "TSIntrinsicKeyword", start, end };
      case 99:
        return { type: "TSThisType", start, end };
      case 100:
        return {
          type: "TSTypeReference",
          start,
          end,
          typeName: f1 !== NULL ? node(f1) : null,
          typeArguments: f2 !== NULL ? node(f2) : null,
        };
      case 101:
        return {
      ...
      case 103:
        return {
          ...
          source: f1 !== NULL ? node(f1) : null,
          options: f2 !== NULL ? node(f2) : null,
          qualifier: f3 !== NULL ? node(f3) : null,
          typeArguments: f4 !== NULL ? node(f4) : null,
        };
      case 104:
        return {
          ...
          name: f1 !== NULL ? node(f1) : null,
          constraint: f2 !== NULL ? node(f2) : null,
          default: f3 !== NULL ? node(f3) : null,
          in: !!(flags & 1),
          out: !!(flags & 2),
          const: !!(flags & 4),
        };
      case 105:
        return { type: "TSTypeParameterDeclaration", start, end, params: nodeArr(f1, f0) };
      case 106:
        return { type: "TSTypeParameterInstantiation", start, end, params: nodeArr(f1, f0) };
      case 107:
        return { type: "TSLiteralType", start, end, literal: f1 !== NULL ? node(f1) : null };
      case 108:
        return {
      ...
      case 109:
        return { type: "TSArrayType", start, end, elementType: f1 !== NULL ? node(f1) : null };
      case 110:
        return {
          type: "TSIndexedAccessType",
          start,
          end,
          objectType: f1 !== NULL ? node(f1) : null,
          indexType: f2 !== NULL ? node(f2) : null,
        };
      case 111:
        return { type: "TSTupleType", start, end, elementTypes: nodeArr(f1, f0) };
      case 112:
        return {
          ...
          label: f1 !== NULL ? node(f1) : null,
          elementType: f2 !== NULL ? node(f2) : null,
          optional: !!(flags & 1),
        };
      case 113:
        return {
      ...
      case 114:
        return { type: "TSRestType", start, end, typeAnnotation: f1 !== NULL ? node(f1) : null };
      case 115:
        return {
      ...
      case 117:
        return { type: "TSJSDocUnknownType", start, end };
      case 118:
        return { type: "TSUnionType", start, end, types: nodeArr(f1, f0) };
      case 119:
        return { type: "TSIntersectionType", start, end, types: nodeArr(f1, f0) };
      case 120:
        return {
          type: "TSConditionalType",
          start,
          end,
          checkType: f1 !== NULL ? node(f1) : null,
          extendsType: f2 !== NULL ? node(f2) : null,
          trueType: f3 !== NULL ? node(f3) : null,
          falseType: f4 !== NULL ? node(f4) : null,
        };
      case 121:
        return { type: "TSInferType", start, end, typeParameter: f1 !== NULL ? node(f1) : null };
      case 122:
        return {
          type: "TSTypeOperator",
          start,
          end,
          operator: TS_TYPE_OPERATORS[flags & 3],
          typeAnnotation: f1 !== NULL ? node(f1) : null,
        };
      case 123:
        return {
      ...
      case 126:
        return {
          ...
          parameterName: f1 !== NULL ? node(f1) : null,
          typeAnnotation: f2 !== NULL ? node(f2) : null,
          asserts: !!(flags & 1),
        };
      case 127:
        return { type: "TSTypeLiteral", start, end, members: nodeArr(f1, f0) };
      case 128:
        return {
          type: "TSMappedType",
          start,
      ...
      case 134:
        return {
          ...
          id: f1 !== NULL ? node(f1) : null,
          typeParameters: f2 !== NULL ? node(f2) : null,
          typeAnnotation: f3 !== NULL ? node(f3) : null,
          declare: !!(flags & 1),
        };
      case 135:
        return {
          ...
          id: f1 !== NULL ? node(f1) : null,
          typeParameters: f2 !== NULL ? node(f2) : null,
          extends: nodeArr(f3, f0),
          body: f4 !== NULL ? node(f4) : null,
          declare: !!(flags & 1),
        };
      case 136:
        return { type: "TSInterfaceBody", start, end, body: nodeArr(f1, f0) };
      case 137:
        return {
      ...
      case 140:
        return { type: "TSEnumBody", start, end, members: nodeArr(f1, f0) };
      case 141:
        return {
          type: "TSEnumMember",
          start,
          ...
          id: f1 !== NULL ? node(f1) : null,
          initializer: f2 !== NULL ? node(f2) : null,
          computed: !!(flags & 1),
        };
      case 142: {
        const r = {
      ...
      case 143:
        return { type: "TSModuleBlock", start, end, body: nodeArr(f1, f0) };
      case 144:
        return {
          type: "TSModuleDeclaration",
          start,
      ...
      case 145: {
        const r = {
          ...
          decorators: nodeArr(f1, f0),
          parameter: f2 !== NULL ? node(f2) : null,
          override: !!(flags & 1),
          readonly: !!(flags & 2),
          accessibility: ACCESSIBILITY[(flags >> 2) & 3],
        };
        if (_isTs) {
          r.static = false;
        }
      ...
      case 149:
        return {
          ...
          typeAnnotation: f1 !== NULL ? node(f1) : null,
          expression: f2 !== NULL ? node(f2) : null,
        };
      case 150:
        return {
      ...
      case 154:
        return {
          ...
          id: f1 !== NULL ? node(f1) : null,
          moduleReference: f2 !== NULL ? node(f2) : null,
          importKind: IMPORT_EXPORT_KINDS[flags & 1],
        };
      case 155:
        return {
      ...
      case 156:
        return {
          ...
          openingElement: f1 !== NULL ? node(f1) : null,
          children: nodeArr(f2, f0),
          closingElement: f3 !== NULL ? node(f3) : null,
        };
      case 157: {
        const r = {
      ...
      case 158:
        return { type: "JSXClosingElement", start, end, name: f1 !== NULL ? node(f1) : null };
      case 159:
        return {
          type: "JSXFragment",
          start,
          end,
          openingFragment: f1 !== NULL ? node(f1) : null,
          children: nodeArr(f2, f0),
          closingFragment: f3 !== NULL ? node(f3) : null,
        };
      case 160:
        return { type: "JSXOpeningFragment", start, end };
      case 161:
      ...
      case 163:
        return {
          ...
          namespace: f1 !== NULL ? node(f1) : null,
          name: f2 !== NULL ? node(f2) : null,
        };
      case 164:
        return {
      ...
      case 166:
        return { type: "JSXSpreadAttribute", start, end, argument: f1 !== NULL ? node(f1) : null };
      case 167:
        return {
      ...
      case 170:
        return { type: "JSXSpreadChild", start, end, expression: f1 !== NULL ? node(f1) : null };
    }
  }
  ...
  function _decodeDiagnostics() {
    ...
    for (let j = 0; j < diagCount; j++) {
      const sev = SEVERITY[_u8[dp]];
      dp++;
      const ds = _p(dv.getUint32(dp, true));
      dp += 4;
      const de = _p(dv.getUint32(dp, true));
      dp += 4;
      const ml = dv.getUint32(dp, true);
      dp += 4;
      const msg = _td.decode(_u8.subarray(dp, dp + ml));
      dp += ml;
      const hh = _u8[dp];
      dp++;
      let help = null;
      if (hh) {
        const hl = dv.getUint32(dp, true);
        dp += 4;
        help = _td.decode(_u8.subarray(dp, dp + hl));
        dp += hl;
      }
      const lc = dv.getUint32(dp, true);
      dp += 4;
      const labels = new Array(lc);
      for (let k = 0; k < lc; k++) {
        const ls = _p(dv.getUint32(dp, true));
        dp += 4;
        const le = _p(dv.getUint32(dp, true));
        dp += 4;
        const lml = dv.getUint32(dp, true);
        dp += 4;
        labels[k] = { start: ls, end: le, message: _td.decode(_u8.subarray(dp, dp + lml)) };
        dp += lml;
      }
  ...
  return {
    ...
    get comments() {
      return _comments !== undefined ? _comments : (_comments = _decodeComments());
    },
    get lineStarts() {
      return _lineStarts !== undefined ? _lineStarts : (_lineStarts = _decodeLineStarts());
    },
    get diagnostics() {
      return _diagnostics !== undefined ? _diagnostics : (_diagnostics = _decodeDiagnostics());
    },
  };
}
export { decode };
